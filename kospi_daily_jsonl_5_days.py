    ...
    for i in range(len(docs) - 6):  # 5일 context + 1일 예측
        try:
            ...
            for j in range(i, i + 5):
                ...
                line = f"{d['Date']}, {d['Open']}, {d['High']}, {d['Low']}, {d['Close']}, {d['Volume']}, {d['Change']}"
...
# 파일 저장
with open("kospi_daily_output_5_days.jsonl", "w", encoding="utf-8") as f:
    f.write(jsonl_str)

print("✅ 수정된 일간 JSONL 생성 완료: daily_output_v2.jsonl")
